...
class AreaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('states')->updateOrInsert(
            ['name_my' => $stateName],
            [...$stateNames, 'latitude' => 21.5, 'longitude' => 98.0, 'created_at' => now(), 'updated_at' => now()],
        );
        ...
        $regionCoordinates = [
            ...
            'မိုင်းစော' => ['latitude' => 21.57317, 'longitude' => 100.846286],
        ];
        ...
        foreach ($regionsData as $regionName => $areas) {
            ...
            $region = DB::table('regions')->where('name_my', $regionName)->where('state_id', $shanState->id)->first();
