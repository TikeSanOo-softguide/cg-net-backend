...
export default function NewsEdit({ categories, item }: Props) {
    ...
    return (
        <>
            ...
            <FormPage>
                <PageHeader title={t('cms.edit_news')} description={t('cms.edit_news_description')} />
                <NewsForm form={form} onSubmit={submit} cancelHref="/cms/news" categories={categories} mode="edit" imageUrl={item.image_url} />
            </FormPage>
        </>
    );
}
