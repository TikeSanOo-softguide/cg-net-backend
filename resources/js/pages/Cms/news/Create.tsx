...
export default function NewsCreate({ categories }: Props) {
    ...
    return (
        <>
            ...
            <FormPage>
                <PageHeader title={t('cms.create_news')} description={t('cms.create_news_description')} />
                <NewsForm form={form} onSubmit={submit} cancelHref="/cms/news" categories={categories} mode="create" />
            </FormPage>
        </>
    );
}
