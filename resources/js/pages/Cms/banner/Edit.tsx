...
export default function BannerEdit({ item }: Props) {
    ...
    return (
        <>
            ...
            <FormPage>
                <PageHeader title={t('cms.edit_banner')} description={t('cms.edit_banner_description')} />
                <BannerForm form={form} onSubmit={submit} cancelHref="/cms/banners" mode="edit" imageUrl={item.image_url} />
            </FormPage>
        </>
    );
}
