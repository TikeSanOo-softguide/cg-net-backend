...
export function SidebarToggle({ expanded, onToggle, label }: SidebarToggleProps) {
    return (
        <button
            ...
            className={cn(
                'absolute top-[calc(var(--navbar-height)/2)] right-0 z-[70] flex size-7 -translate-y-1/2 translate-x-1/2 items-center justify-center rounded-full',
                'bg-primary text-primary-foreground shadow-[0_2px_8px_rgb(23_50_54/0.28)]',
