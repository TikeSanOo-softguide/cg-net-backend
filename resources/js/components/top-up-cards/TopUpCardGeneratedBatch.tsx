...
import { formatTopUpNumber, TOP_UP_CARD_CURRENCY, type TopUpCardRow } from '@/lib/top-up-cards';
                ...
                {cards.map((card) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <p className="mt-2 flex items-baseline gap-1 pl-1.5">
                            ...
                            <div className="mt-2 ml-1.5 flex items-center justify-between gap-2 rounded-[6px] border border-dashed border-primary/25 bg-card/70 px-2 py-1">
